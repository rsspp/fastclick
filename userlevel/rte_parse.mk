############################################################
## Flow API library enable since 17.05 and HAVE_FLOW_API
############################################################

ifeq ($(shell [ -n "$(RTE_VER_YEAR)" ] && ( ( [ "$(RTE_VER_YEAR)" -ge 17 ] && [ "$(RTE_VER_MONTH)" -ge 5 ] ) || [ $(RTE_VER_YEAR) -ge 18 ] ) && echo true)${HAVE_FLOW_API},true1)

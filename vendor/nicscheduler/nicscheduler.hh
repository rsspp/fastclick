...
/**
 * Structure used by Metron and RSS++ to keep track of CPU usage and movements
 */
class LoadTracker {
    public:
 ...
 * or down.
 *
 * NICScheduler can use multiple balancing method: Metron, RSS, a round-robin RSS or
